<script lang="ts">
    ...
    export let enableStopWaves: boolean = true; // Whether to show the "Stop All Waves" functionality
...
<AdminCard>
    <svelte:fragment slot="header">
        <div class="flex justify-between items-center">
            <div>
                <h3 class="text-lg font-medium">Deployment Batches</h3>
                    <p class="text-sm text-muted-foreground">Manage deployment batches for this bundle</p>
            </div>
            {#if showStopButton}
                <Button 
                    variant="destructive" 
                ...
                >
                    ...
                    {stoppingWaves ? 'Stopping...' : 'Stop All Batches'}
                </Button>
            {/if}
        </div>
    </svelte:fragment>
    ...
    {:else if empty}
        <div class="py-8 text-center">
            <div>
                <h3 class="mt-4 text-lg font-medium">No batches created</h3>
                <p class="mt-2 text-sm text-muted-foreground">
                    Batches will be created when this bundle is published
                </p>
            </div>
        </div>
    {:else}
            ...
            <div class="grid grid-cols-3 gap-4 md:grid-cols-5">
                <Card>
                    <CardContent class="p-4 text-center">
                        <p class="text-xs font-medium uppercase text-muted-foreground">Total Batches</p>
                ...
                <Card>
                    <CardContent class="p-4 text-center">
                        <p class="text-xs font-medium uppercase text-muted-foreground">Batches Completed</p>
                ...
                <Card>
                    <CardContent class="p-4 text-center">
                        <p class="text-xs font-medium uppercase text-muted-foreground">Batches In Progress</p>
                ...
                <Card>
                    <CardContent class="p-4 text-center">
                        <p class="text-xs font-medium uppercase text-muted-foreground">Batches Failed</p>
                ...
                <Card>
                    <CardContent class="p-4 text-center">
                        <p class="text-xs font-medium uppercase text-muted-foreground">Batches Cancelled</p>
                            ...
                            >
                                ...
                                <TableCell>
                                    <div class="flex items-center gap-2">
                                        <Progress value={wave.progress ?? 0} class="w-[100px]" />
                                        <span class="text-sm text-muted-foreground">{wave.progress ?? 0}%</span>
                                    </div>
                                </TableCell>
                                <TableCell>
        ...
        <div class="text-xs text-muted-foreground">
            ...
            {#if enableStopWaves}
                {#if hasCancelledWaves}
                    <p class="text-orange-600 font-medium">⚠️ Some batches have been cancelled. The deployment process has been stopped.</p>
